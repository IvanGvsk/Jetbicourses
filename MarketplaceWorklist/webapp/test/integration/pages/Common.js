sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("zjblessons/MarketplaceWorklist/app", ".html");
		...
		return Opa5.extend("zjblessons.MarketplaceWorklist.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["zjblessons/MarketplaceWorklist/localService/mockserver"], function (mockserver) {
